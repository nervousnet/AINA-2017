...
import ch.ethz.coss.nervousnetgen.storage.DynamicStorageHandler;
import ch.ethz.coss.nervousnetgen.storage.iDatabaseHelper;
...
public class Wrapper_v2 implements iWrapper, SensorEventListener {
    ...
    private iDatabaseHelper databaseHandler;
    ...
    public Wrapper_v2(Context context, String sensorName, String[] paramNames, String[] typeNames, String[] metadata,
        ...
        this.databaseHandler = new DynamicStorageHandler(context, sensorName, columnNames, columnTypes);
